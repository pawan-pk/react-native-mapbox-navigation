...
public class MapboxNavigationView: UIView {
    var embedded: Bool
    var embedding: Bool
...
//    func setWaypoints(waypoints: [MapboxNavigationViewWaypointsStruct]) {
...
//    @objc var onLocationChange: MapboxNavigationViewEventEmitter?
